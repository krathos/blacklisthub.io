...
return [
    ...
    'description' => 'API documentation for the Blacklist reporting system. This API allows companies to report and search for clients in a shared blacklist across multiple business categories.',
...
INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'You can get your token by logging in via the <code>POST /v1/auth/login</code> endpoint.',
    ],
